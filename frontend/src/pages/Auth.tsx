...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      {/* Left Side: Form Area */}
      <div className="flex items-center justify-center p-8 bg-background transition-colors duration-300 relative overflow-hidden">
        {/* Ambient Glows */}
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in-up">
          <div className="text-center space-y-2">
             <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/20 mb-4">
                <span className="text-slate-900 dark:text-white font-bold text-2xl">B</span>
             </div>
             <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Welcome to BarterVerse</h1>
             <p className="text-slate-600 dark:text-slate-400">Your gateway to decentralized trading.</p>
          </div>

          <Card className="border-0 bg-transparent shadow-none">
            <CardContent className="p-0">
              <Tabs defaultValue="login" className="w-full">
                <TabsList className="grid w-full grid-cols-2 bg-white dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800 mb-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:ring-emerald-500/50 rounded-xl h-11"
                ...
                <TabsContent value="signup">
                  <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-slate-600 dark:text-slate-400">Create Password</Label>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500" />
                        <Input
                          type="password"
      ...
      <div className="hidden lg:flex flex-col items-center justify-center p-12 bg-white dark:bg-slate-900 relative">
          ...
          <div className="relative z-10 max-w-lg text-center space-y-6">
             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-slate-200 dark:border-slate-800 backdrop-blur-md text-emerald-300 mb-4">
